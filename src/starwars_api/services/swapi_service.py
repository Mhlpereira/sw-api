...
class SwapiService:
    ...
    async def list_people(
        ...
        try:
            ...
            async with httpx.AsyncClient() as client:
                ...
                if sort_by:
                    data["results"] = DataSorter.sort(data["results"], sort_by, order)

                formatted_results = await resolve_name_fields(
                    data["results"],
        ...
        try:
            ...
            async with httpx.AsyncClient() as client:
                response = await client.get(
                    f"{self.api_url}starships", params=api_params
                )
                response.raise_for_status()
                data = response.json()
    ...
    async def list_vehicles(
        ...
        try:
            ...
            async with httpx.AsyncClient() as client:
                response = await client.get(
                    f"{self.api_url}vehicles", params=api_params
                )
                response.raise_for_status()
                data = response.json()
